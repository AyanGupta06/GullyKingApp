...
class RankedTeam2ScorecardPage extends StatefulWidget {
  final String timestamp;

  const RankedTeam2ScorecardPage({
    Key? key,
    required this.timestamp,
  }) : super(key: key);

  @override
  State<RankedTeam2ScorecardPage> createState() => _RankedTeam2ScorecardPageState();
}

class _RankedTeam2ScorecardPageState extends State<RankedTeam2ScorecardPage> {
