...
class RankedTeam1ScorecardPage extends StatefulWidget {
  final String timestamp;

  const RankedTeam1ScorecardPage({
    Key? key,
    required this.timestamp,
  }) : super(key: key);

  @override
  State<RankedTeam1ScorecardPage> createState() => _RankedTeam1ScorecardPageState();
}

class _RankedTeam1ScorecardPageState extends State<RankedTeam1ScorecardPage> {
            ...
            child: Column(
              ...
              children: [
                ...
                ...team2Players.map<Widget>((player) {
                  final bowlerName = player['email'] ?? 'Unknown';
