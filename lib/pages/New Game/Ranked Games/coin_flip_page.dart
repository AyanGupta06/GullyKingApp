...
//       winner = flipResult == call ? flippingTeam : (flippingTeam == widget.yourTeamID ? widget.opponentTeamID : widget.yourTeamID);
...
//                   child: Image.asset(
//                     flipResult == null || isFlipping ? 'assets/coin_heads.png' : (flipResult == 'Heads' ? 'assets/coin_heads.png' : 'assets/coin_tails.png'),
//                     width: 100,
//                   ),
//                 );
//               },
        ...
        child: Column(
          children: [
            ...
            if (!isFlipping && flipResult != null)
              Image.asset(
                flipResult == 'Heads' ? 'assets/coin_heads.png' : 'assets/coin_tails.png',
                width: 100,
              ),
